---
title: 유니패스로 직구 통관 상태 직접 조회하는 법 — 운송장 번호만 있으면 끝
slug: unipass-customs-tracking-guide
tags: [유니패스, 통관조회, 화물진행정보, 해외직구통관, 개인통관고유부호]
category: 6
schedule: now
calculator: none
...
answer_summary: |
  직구 통관 상태는 관세청 유니패스(unipass.customs.go.kr)에서 직접 조회할 수 있습니다. 운송장(B/L) 번호만 있으면 로그인 없이 '화물진행정보'에서 지금 어느 단계인지 보이고, 개인통관고유부호로는 본인인증 후 내 이름으로 통관된 전체 내역을 확인할 수 있습니다. '수입신고수리' 또는 '반출'이 뜨면 통관 완료입니다.
faq:
  - q: 유니패스는 로그인해야 조회할 수 있나요?
    a: 운송장(B/L) 번호나 화물관리번호로 하는 '화물진행정보' 조회는 로그인 없이 됩니다. 다만 개인통관고유부호로 내 전체 통관내역을 보려면 본인인증(로그인)이 필요합니다.
  - q: 통관이 어느 단계면 다 끝난 건가요?
    a: "'수입신고수리' 또는 '반출'이 표시되면 통관이 완료돼 국내 배송 단계로 넘어간 것입니다. 특송 목록통관은 '목록통관 수리'가 뜨면 완료입니다."
  - q: 운송장 번호는 어디서 찾나요?
    a: 주문한 쇼핑몰이나 배송대행지 마이페이지, 또는 특송업체(페덱스·DHL 등) 배송조회 화면에서 확인할 수 있습니다. 보통 B/L번호나 송장번호로 표기됩니다.
thumbnail_brief: |
  최고급 경제·물류 매거진 커버 스타일 블로그 썸네일, 가로형. 프레시 쿨 팔레트 — 페일 블루~틸 배경 + 깔끔한 조명, 8K 광고 품질.
  금박 질감의 큰 한글 텍스트 '유니패스 조회', 흰색 작은 텍스트 '통관 상태 직접 확인'.
  스마트폰 화면에 배송추적을 보는 손, 옆에 무상표 택배상자 하나. 실제 브랜드 로고·실제 사이트 화면 금지(가상의 무상표 디자인).
  한글 텍스트 정확히: 유니패스 조회 / 통관 상태 직접 확인
body_image_brief: |
  가로형 실사풍 본문 이미지. 썸네일과 같은 프레시 쿨 팔레트(페일 블루+틸, 깔끔한 조명).
  책상 위에서 노트북과 스마트폰으로 배송·통관 상태를 확인하는 장면, 옆에 택배상자. 텍스트·브랜드 로고·실제 UI 화면 금지(숫자만 허용).
body_image_alt: 노트북과 스마트폰으로 직구 통관 상태를 조회하는 모습
---
...
<!-- 등록됨: post 398 / publish / 2026-08-23T22:09:51 / media 396 -->
